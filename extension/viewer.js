...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderTable() {
        ...
        bidsToShow.forEach(bid => {
            ...
            // --- PERMISSION CHECK ---
            // Only show the Delete icon if the user's Google ID matches the one saved with the bid.
            // This prevents users from deleting bids added by others.
            const canDelete = currentUserGoogleId && bid.googleUserId === currentUserGoogleId;
    ...
    function getUserColor(name) {
        if (!name) return { bg: '#e2e8f0', text: '#4a5568' }; // Default gray for unknown names.
        ...
        // Pastel colors palette for other users.
        const colors = [
